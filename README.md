...
Proyecto Web para CIFO La Violeta como ejercicio de maquetación avanzada utilizando HTML y CSS moderno.
...
[](https://github.com/FCS-dev/editoline-web#-estructura-del-proyecto)

/[proyecto] │ ├── index.html ├── css/ │ └── styles.css ├── imgs/ │ ├── autores/ │ └── recomendación/ │ └── portadas/ │ └── screenshots/ └── README.md
...
[direccion del github del proyecto]

Nombre de los alumnos: [nombres de los alumnos]  Curso: Confección y Publicación Web Año: 2026
